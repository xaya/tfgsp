...
private:
   ...
   * into the database.
   */
  explicit RecipeInstance (Database& d, const std::string& o, const std::string& cr);
   ...
   */
  explicit RecipeInstance (Database& d,
                      const Database::Result<RecipeInstanceResult>& res);
...
public:
   ...
   */
  Handle CreateNew (const std::string& owner, const std::string& cr);
