...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2fxaya_5fplayer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::pxd::proto::XayaPlayer, ftuestate_),
  PROTOBUF_FIELD_OFFSET(::pxd::proto::XayaPlayer, ongoings_),
  1,
  2,
  3,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, sizeof(::pxd::proto::XayaPlayer)},
};
...
const char descriptor_table_protodef_proto_2fxaya_5fplayer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027proto/xaya_player.proto\022\tpxd.proto\032\023pr"
  "oto/ongoing.proto\"\251\001\n\nXayaPlayer\022\017\n\007notu"
  "sed\030\001 \001(\r\022\014\n\004role\030\002 \001(\r\022\017\n\007balance\030\003 \001(\004"
  "\022\030\n\020burnsale_balance\030\004 \001(\004\022\020\n\010xayaname\030\005"
  " \001(\t\022\021\n\tftuestate\030\006 \001(\r\022,\n\010ongoings\030\007 \003("
  "\0132\032.pxd.proto.OngoinOperationB\003\370\001\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_proto_2fxaya_5fplayer_2eproto_deps[1] = {
  &::descriptor_table_proto_2fongoing_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fxaya_5fplayer_2eproto = {
  false, false, 234, descriptor_table_protodef_proto_2fxaya_5fplayer_2eproto, "proto/xaya_player.proto", 
  &descriptor_table_proto_2fxaya_5fplayer_2eproto_once, descriptor_table_proto_2fxaya_5fplayer_2eproto_deps, 1, 1,
...
class XayaPlayer::_Internal {
 public:
  ...
  static void set_has_ftuestate(HasBits* has_bits) {
    (*has_bits)[0] |= 32u;
  }
};

void XayaPlayer::clear_ongoings() {
  ongoings_.Clear();
}
...
XayaPlayer::XayaPlayer(const XayaPlayer& from)
  ...
  ::memcpy(&notused_, &from.notused_,
    static_cast<size_t>(reinterpret_cast<char*>(&ftuestate_) -
    reinterpret_cast<char*>(&notused_)) + sizeof(ftuestate_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&ftuestate_) -
    reinterpret_cast<char*>(&notused_)) + sizeof(ftuestate_));
}
...
// @@protoc_insertion_point(message_clear_start:pxd.proto.XayaPlayer)
  ...
  if (cached_has_bits & 0x0000003eu) {
    ::memset(&notused_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&ftuestate_) -
        reinterpret_cast<char*>(&notused_)) + sizeof(ftuestate_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          _Internal::set_has_ftuestate(&has_bits);
          ftuestate_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_ongoings(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* XayaPlayer::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(6, this->_internal_ftuestate(), target);
  }

  // repeated .pxd.proto.OngoinOperation ongoings = 7;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_ongoings_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(7, this->_internal_ongoings(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:pxd.proto.XayaPlayer)
  ...
  // repeated .pxd.proto.OngoinOperation ongoings = 7;
  total_size += 1UL * this->_internal_ongoings_size();
  for (const auto& msg : this->ongoings_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:pxd.proto.XayaPlayer)
  ...
  ongoings_.MergeFrom(from.ongoings_);
...
void XayaPlayer::InternalSwap(XayaPlayer* other) {
  ...
  ongoings_.InternalSwap(&other->ongoings_);
  xayaname_.Swap(&other->xayaname_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(XayaPlayer, ftuestate_)
      + sizeof(XayaPlayer::ftuestate_)
