...
| FN11 | B | src/logic.cpp:742-765 | fork-baggage | low | neutral | Confusing lmt/rmt swap with leftover scratch comment in ExecuteOneMoveAgainstAnother | DEFERRED(B2) |
